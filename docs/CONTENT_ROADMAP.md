...
> **Built:** the crossing system with both skins (sheep, ducks) and the honk that scatters them (`docs/GDD.md`
> section 4). **Not built yet:** the tipped cart, mud, and the weather. Barley's wave to the flock is also still
> on this list.
